...
class ComprobanteCreditoFiscalElectronico(GeneratedsSuper):
    """Elemento Raiz de Comprobante de Credito Fiscal Electronico"""
    subclass = None
    superclass = None
...
class Receptor(GeneratedsSuper):
    ...
    def __init__(self, nit=None, nombre=None, nrc=None, codActividad=None, nombreComercial=None,
...
class Item(GeneratedsSuper):
    ...
    def __init__(self, numItem, tipoItem=None, descripcion=None, cantidad=None, uniMedida=None, precioUni=None,
                 ...
                 ventaGravada=0.00, psv=0.00, noGravado=0.00, tributos=None):
        self.original_tagname_ = None
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='EmisorType', fromsubclass_=False,
        ...
        if self.numeroDocumento is not None:
            ...
            outfile.write(bytes(('"numeroDocumento":%s,%s' % (
                self.gds_encode(self.gds_format_string(quote_xml(self.numeroDocumento),
        ...
        if self.codTributo is not None:
            ...
            outfile.write(bytes(('"codTributo":"%s",%s' % (
                self.gds_encode(
                    self.gds_format_string(quote_xml(self.codTributo), input_name='Tributo sujeto a cálculo de IVA')),
                eol_)).encode()))
        else:
            showIndent(outfile, level, pretty_print)
...
class Resumen(GeneratedsSuper):
    ...
    def __init__(self, totalNoSuj=0.00, totalLetras=None, ivaRete1=0.00,
                 subTotalVentas=0.00, subTotal=0.00, ivaPerci1=0.00, reteRenta=0.00, descuExenta=0.00,
                 totalDescu=0.00, tributos=None, descuGravada=0.00, totalGravada=0.00, porcentajeDescuento=0.00,
                 montoTotalOperacion=0.00, totalNoGravado=0.00, totalPagar=0.00, saldoFavor=0.00,
