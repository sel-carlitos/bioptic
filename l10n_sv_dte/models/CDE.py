...
class Emisor(GeneratedsSuper):
    ...
    def __init__(self, tipoDocumento=None, numDocumento=None, nrc=None, nombre=None, codActividad=None, descActividad=None, telefono=None,
                 correo=None, nombreComercial=None, tipoEstablecimiento=None, direccion=None,
