...
class Item(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            or self.psv is not None
            or self.noGravado is not None
            or self.ivaItem is not None
        ):
            return True
        else:
            return False
            ...
            outfile.write(
                bytes(
                    (
                        '"psv":%s,%s'
                        % (
                            self.gds_encode(self.gds_format_float(self.psv, input_name='Precio sugerido de venta')),
                            eol_,
                        )
                    ).encode()
                )
        ...
        if self.ivaItem is not None:
            ...
            outfile.write(
                bytes(
                    (
                        '"ivaItem":%s,%s'
                        % (self.gds_encode(self.gds_format_float(self.ivaItem, input_name='IVA 13%')), eol_)
                    ).encode()
                )
            )
...
class Resumen(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            or self.totalIva is not None
            or self.saldoFavor is not None
        ...
        if self.saldoFavor is not None:
            ...
            outfile.write(
                bytes(
                    (
                        '"saldoFavor":%s,%s'
                        % (self.gds_encode(self.gds_format_float(self.saldoFavor, input_name='Saldo a Favor')), eol_)
                    ).encode()
                )
            )
        ...
        if self.totalIva is not None:
            ...
            outfile.write(
                bytes(
                    (
                        '"totalIva":%s,%s'
                        % (self.gds_encode(self.gds_format_float(self.totalIva, input_name='IVA 13%')), eol_)
                    ).encode()
                )
            )
