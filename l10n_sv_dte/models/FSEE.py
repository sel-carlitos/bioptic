...
class FacturaSujetoExcluidoElectronico(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ECF', fromsubclass_=False,
        ...
        if self.receptor is not None:
            self.receptor.export(outfile, level, namespace_, name_='sujetoExcluido', pretty_print=pretty_print)
...
class Resumen(GeneratedsSuper):
    ...
    def get_totalCompra(self):
        return self.totalCompra

    def set_totalCompra(self, totalCompra):
        self.totalCompra = totalCompra
