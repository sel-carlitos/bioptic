...
class AccountMove(models.Model):
    ...
    l10n_sv_available_voucher_type_ids = fields.Many2many(
        'l10n_sv.voucher.type', compute='_compute_l10n_sv_available_document_types'
    )
    ...
    l10n_sv_electronic_stamp = fields.Text(
        string='Electronic Stamp', readonly=True, copy=False, related='l10_sv_dte_id.l10n_sv_electronic_stamp'
    )
    ...
    l10n_sv_date_issue_ref = fields.Datetime(string='Fecha y hora de emisión del DTE de referencia', copy=False)
    l10n_sv_generation_code_ref = fields.Char(
        'Código de generación de referencia', copy=False, help='Código de generacion del DTE de referencia'
    )
    ...
    def l10n_sv_create_document(self, terminal_id, recreate=False):
        if not self.l10_sv_dte_id or recreate:
            ...
            ).default_get(['state', 'company_id', 'l10n_sv_dte_situation', 'ind_state', 'l10n_sv_economic_activity_id'])
